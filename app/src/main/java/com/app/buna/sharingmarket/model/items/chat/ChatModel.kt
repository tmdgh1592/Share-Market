...
data class ChatModel(val users: HashMap<String, Boolean> = HashMap(), val comments: HashMap<String, Comment> = HashMap(), val pushState: HashMap<String, Boolean> = HashMap(), val lastMessage: String="", val lastTimestamp: Long = 0L) {
