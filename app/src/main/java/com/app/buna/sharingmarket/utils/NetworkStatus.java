...
public class NetworkStatus {
    ...
    /*public static int getConnectivityStatus(@NotNull Context context) { //해당 context의 서비스를 사용하기위해서 context객체를 받는다.
    ...
    public static boolean isConnectedInternet(@NotNull Context context) {
        ConnectivityManager manager = (ConnectivityManager) context.getSystemService(context.CONNECTIVITY_SERVICE);
